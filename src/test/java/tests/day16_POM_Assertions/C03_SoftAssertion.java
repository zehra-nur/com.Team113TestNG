...
public class C03_SoftAssertion {
    ...
    public void hardAssertion(){
        ...
        Assert.assertTrue(sayi%33 == 0,"sayi 3'e bolunememeli"); // sayinin 3 ile bolunebilmesini test edin
    }
    @Test
    public void softAssertionTesti(){
        /*
           ...
           assertAll() calistiginda assertion'lara ait raporu verir
           ANCAK hangi satirda olduklarini vermez

           Selenium hata mesajı da assertAll()'un bulundugu satiri isaret eder.

           Failed olan assertionlari kolaylikla bulabilmemiz icin
         */
        ...
        softAssert.assertTrue(sayi%33 == 0,"sayi 3'e bolunememeli"); // sayinin 3 ile bolunebilmesini test edin
